    ...
    <div className="space-y-8 animate-fadeIn max-w-7xl mx-auto p-4 md:p-0">
      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm font-light mt-1">GLOBAL // PLANO_INTERACTIVO_DEL_CONGRESO</p>
        </div>
      ...
      <GlassCard className="p-8 min-h-[500px] flex flex-col items-center justify-center" glowColor="emerald">
        ...
        <h2 className="text-2xl font-bold text-[#0f172a] mb-2">Plano del Congreso IGE 2026</h2>
        <p className="text-slate-500 text-sm max-w-lg text-center mb-8 font-light">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-2xl">
          <div className="flex items-center gap-2 p-3 rounded-xl bg-slate-50 border border-slate-200">
            ...
            <span className="text-xs text-slate-500 font-light">Developer Land</span>
          </div>
          <div className="flex items-center gap-2 p-3 rounded-xl bg-slate-50 border border-slate-200">
            <HiOutlineLocationMarker className="w-4 h-4 text-purple-700" />
            <span className="text-xs text-slate-500 font-light">Data Land</span>
          </div>
          <div className="flex items-center gap-2 p-3 rounded-xl bg-slate-50 border border-slate-200">
            <HiOutlineLocationMarker className="w-4 h-4 text-amber-700" />
            <span className="text-xs text-slate-500 font-light">Cloud Land</span>
          </div>
          <div className="flex items-center gap-2 p-3 rounded-xl bg-slate-50 border border-slate-200">
            <HiOutlineLocationMarker className="w-4 h-4 text-emerald-700" />
            <span className="text-xs text-slate-500 font-light">IA Land</span>
          </div>
        </div>
