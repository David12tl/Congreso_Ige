...
// Geometría del Bloque 1 (Superior): 17 filas de 10 a 14 asientos = 218 asientos exactos
// Suma: (3×10) + (3×11) + (3×12) + (4×13) + (4×14) = 30 + 33 + 36 + 52 + 56 = 218
const BLOCK_TOP_ROWS = [10, 10, 10, 11, 11, 11, 12, 12, 12, 13, 13, 13, 13, 14, 14, 14, 14];

// Geometría del Bloque 2 (Inferior): 15 filas de 15 asientos = 225 asientos exactos
// Suma: 15 filas × 15 asientos = 225
const BLOCK_BOTTOM_ROWS = [15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15];

/**
 * Genera etiquetas de filas estilo abecedario (A..Z, AA, AB, AC, AD, AE, AF)
 */
                    ...
                    <button
                      ...
                      className={`
                        ...
                        ${isOccupied 
                          ...
                          : isSelected
                            ? 'bg-blue-600 text-white border-blue-600 scale-110 shadow-md ring-2 ring-blue-600/30'
  ...
  return (
    <div className="w-full flex flex-col items-center bg-slate-50 p-6 rounded-2xl border border-slate-200 shadow-sm overflow-x-auto">
      ...
      <div className="flex flex-col items-center gap-8 min-w-max">
        ...
        {/* BLOQUE SUPERIOR / BLOQUE 1 (218 Asientos - 17 Filas: A a Q) */}
        ...
        {/* BLOQUE INFERIOR / BLOQUE 2 (225 Asientos - 15 Filas: R a AF) */}
        <div className="relative p-6 rounded-2xl bg-slate-200/50 border border-slate-300/60 flex flex-col items-center">
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#1E2A39] text-white text-[10px] font-black uppercase tracking-wider px-3 py-0.5 rounded-full shadow-sm">
