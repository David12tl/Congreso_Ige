...
const AuroraBackground = dynamic(
  () => import('@/components/ui/AuroraBackground'),
  { ssr: false }
);
  ...
  return (
    <AuroraBackground>
      <main className="relative z-10 w-full min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 md:pt-32 pb-16">
          ...
          <section className="mb-16 md:mb-24 scroll-reveal">
            ...
            <div className="bg-white dark:bg-slate-900/60 dark:border-slate-800 border border-congreso-teal/10 shadow-2xl rounded-3xl p-6 md:p-12 relative overflow-hidden">
              {/* Adornos de fondo */}
              <div
              ...
              <h2 className="text-3xl md:text-5xl font-black mb-8 uppercase tracking-tighter bg-gradient-to-r from-congreso-dark via-congreso-blue to-congreso-teal bg-clip-text text-transparent">
                Nuestra Historia
              </h2>

              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                {/* Columna de texto — ocupa 2 de 3 columnas */}
                <div className="lg:col-span-2 space-y-6 text-base text-congreso-dark/80 dark:text-slate-400 leading-relaxed text-justify">
                  <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
              ...
              <div className="scroll-reveal bg-white dark:bg-slate-900/60 dark:border-slate-800 border border-congreso-teal/10 shadow-2xl rounded-3xl p-8 relative overflow-hidden group transition-all duration-300 hover:shadow-[0_0_50px_-12px_rgba(0,151,167,0.2)]">
                ...
                <div className="border-l-4 border-congreso-teal pl-6">
                  ...
                  <p className="text-base text-congreso-dark/80 dark:text-slate-400 leading-relaxed text-justify">
