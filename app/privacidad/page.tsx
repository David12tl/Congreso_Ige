      ...
      <div className="relative pt-40 pb-24 px-4 min-h-[calc(100vh-80px)]">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <header className="mb-16 text-center animate-fadeIn">
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-congreso-dark uppercase mb-6 leading-tight">
            ...
            <p className="text-congreso-dark/40 text-sm font-mono uppercase tracking-[0.2em]">
          ...
          <div className="grid gap-6 md:gap-8">
            ...
            {/* 01. Responsable */}
            <section className="group relative bg-white border border-congreso-teal/10 rounded-2xl p-8 hover:border-congreso-teal/30 transition-all duration-500 shadow-xl">
              <div className="flex items-start gap-6">
                ...
                <div className="space-y-3">
                  <h2 className="text-xl font-bold text-congreso-dark tracking-tight flex items-center gap-2">
                    01. Responsable del Tratamiento de Datos
                  </h2>
                  <p className="text-congreso-dark/70 leading-relaxed">
            ...
            {/* 02. Datos Recabados */}
            <section className="group relative bg-white border border-congreso-teal/10 rounded-2xl p-8 hover:border-congreso-blue/30 transition-all duration-500 shadow-xl">
              <div className="flex items-start gap-6">
                ...
                <div className="space-y-4">
                  <h2 className="text-xl font-bold text-congreso-dark tracking-tight">
                    02. Datos Recabados
                  </h2>
                  <p className="text-congreso-dark/70 leading-relaxed">
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {['Nombre completo', 'Correo electrónico (Google Auth)', 'Unidad Académica', 'Estado del pago'].map((item) => (
                      <li key={item} className="flex items-center gap-2 text-sm text-congreso-dark/80 font-mono">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="p-3 rounded-lg bg-congreso-teal/5 border border-congreso-teal/10">
                      <p className="text-sm text-congreso-dark/80 leading-relaxed">
            ...
            <section className="group relative bg-white border border-congreso-teal/10 rounded-2xl p-8 hover:border-congreso-blue/30 transition-all duration-500 shadow-xl">
              <div className="flex items-start gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-congreso-dark/70 leading-relaxed">
                    Los datos están protegidos mediante las políticas de seguridad <strong className="text-congreso-dark">RLS (Row Level Security)</strong> directamente en la infraestructura en la nube de <strong className="text-congreso-teal">Supabase</strong>, impidiendo que usuarios de nivel básico o externos intercepten la información de los otros sistemas o perfiles ajenos.
                  </p>
                </div>
              </div>
            </section>
          ...
          {/* Footer de sección */}
          <div className="mt-20 text-center border-t border-congreso-teal/10 pt-12">
            <p className="text-congreso-dark/30 text-xs font-mono tracking-widest uppercase">
