...
const campoLaboral = [
  ...
  },
  {
    ...
    gradient: 'from-sky-600/40 to-indigo-600/20',
  },
];
    ...
    <main className="relative z-10 w-full min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        ...
        <div className="mb-10 scroll-reveal">
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-surface-card border border-border-subtle text-text-main hover:bg-purple-500/10 hover:border-purple-500/40 transition-all duration-300 shadow-sm text-sm font-medium backdrop-blur-md group"
          >
        ...
        <header className="mb-16 md:mb-20 scroll-reveal">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight bg-gradient-to-r from-purple-500 via-purple-400 to-fuchsia-400 bg-clip-text text-transparent">
            Ingeniería en Gestión<br />
            <span className="text-text-main">Empresarial</span>
          </h1>
        ...
        <section className="mb-20 md:mb-28 scroll-reveal">
          ...
          <div className="flex items-center gap-4 mb-10">
            ...
            <h2 className="text-2xl md:text-3xl font-black uppercase tracking-tight text-text-main">
              Perfil de Ingreso
            </h2>
            <div className="flex-1 h-[2px] bg-gradient-to-l from-purple-500/30 to-transparent" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {perfilIngreso.map((item) => (
              <div
                key={item.num}
                className="bg-surface-card border border-border-subtle p-5 rounded-2xl shadow-md transition-all duration-300 hover:scale-[1.02] hover:border-purple-500/30 scroll-reveal relative group"
              >
                {/* Número secuencial brillante */}
                <span className="absolute top-3 right-4 text-3xl md:text-4xl font-black leading-none bg-gradient-to-b from-purple-500/40 to-transparent bg-clip-text text-transparent select-none">
                  {item.num}
                </span>

                {/* Contenido */}
                <h3 className="text-base font-bold text-text-main mb-2 pr-12">
                  {item.keyword}
                </h3>
          ...
          <p className="text-xs text-text-muted/60 text-center mt-10 font-mono tracking-wide">
        ...
        <section className="scroll-reveal">
          ...
          <p className="text-text-muted text-base md:text-lg mb-10 max-w-3xl leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            {campoLaboral.map((item, idx) => (
              <div
                key={idx}
                className="bg-surface-card border border-border-subtle rounded-2xl overflow-hidden shadow-md transition-all duration-300 hover:scale-[1.01] hover:shadow-[0_0_50px_-12px_rgba(168,85,247,0.2)] scroll-reveal group"
              >
                {/* Banner superior con gradiente */}
                <div
                  className={`bg-gradient-to-r ${item.gradient} px-6 py-4 border-b border-border-subtle`}
                >
                ...
                <div className="p-6">
                  <p className="text-text-main text-sm md:text-base text-justify leading-relaxed">
                    {item.desc}
                  </p>
                </div>
              </div>
          ...
          <div className="mt-14 text-center scroll-reveal">
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-surface-card border border-border-subtle text-sm text-text-muted font-mono">
