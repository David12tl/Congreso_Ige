...
export default function CongresoPage() {
  ...
  return (
    <div className={`${tokens.bg} ${tokens.text} font-['Montserrat'] overflow-x-hidden min-h-screen antialiased`}>
      ...
      <section style={styles.heroGradient} className="w-full border-b border-slate-200/60 z-10 relative overflow-hidden">
  <div className="w-full max-w-[1440px] mx-auto">
    <div className="grid grid-cols-1 md:grid-cols-2 items-stretch">
      
      {/* Columna Texto con Padding Equilibrado */}
      <div className="flex flex-col justify-center py-16 px-6 md:py-24 md:px-16 lg:px-24 bg-white md:bg-transparent">
        ...
        {/* Título Principal */}
        <h1 style={{ color: tokens.primary }} className="text-[36px] md:text-[48px] font-extrabold tracking-tight mb-1 leading-[1.1]">
          1er Congreso Internacional
        </h1>
        
        {/* Nombre del Congreso Sincronizado y Responsivo */}
        <h2 
          className="text-[40px] md:text-[56px] font-black tracking-tighter uppercase leading-none mb-6" 
          style={{ 
        ...
        <div className="flex flex-wrap gap-2.5 mb-8 mt-2">
      ...
      <div className="relative w-full h-[350px] md:h-auto min-h-[250px] md:min-h-[600px] select-none z-10">
        <Image 
          src="/Fondo_Hero.jpg" 
          alt="Escudo Geométrico" 
          fill
          priority
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center z-10 w-full bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10">
            ...
            <div className="lg:col-span-4 border-r border-white/10 pr-4 flex flex-col justify-center">
              ...
              <h2 className="text-3xl md:text-4xl font-black tracking-tighter text-white mb-1">
                Gestión Empresarial <span className="text-[#8B1E23]">ELiGE</span>
              </h2>
